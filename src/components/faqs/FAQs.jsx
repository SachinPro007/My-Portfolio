...
const FAQItem = ({ faq, themeColors, index, open, setOpen }) => {
  const keywords = [
    ...
    "right now is deepening my knowledge of Next.js by building a new project with TypeScript",
    "solid understanding of how frontend systems connect with backend APIs",
    "built my own API routes within Next.js",
    "Next.js has given me hands-on skills in building full-stack applications",
    "React",
    "Next.js",
    "TypeScript",
    "best practices",
    ...
    "workflow optimization—keeping my productivity sharp",
